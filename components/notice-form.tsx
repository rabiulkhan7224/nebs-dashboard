...
const [open, setOpen] = useState(false)
        ...
        <div className="space-y-8 p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div>
                <Label htmlFor="target">Target Department(s) or Individual</Label>
              ...
              <div className="md:col-span-2">
                <Label htmlFor="title">Notice Title <span className="text-rose-500">*</span></Label>
                <Input
                  {...register("title")}
                ...
                <div>
                  ...
                  <Select onValueChange={(v) => setValue("employeeId", v)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="EMP002">EMP002 - Jane Smith</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
          ...
          >
            <span className="flex flex-wrap gap-1.5">
              {field.value.length > 0 ? (
                ...
                <span className="text-muted-foreground">Select Notice Type</span>
              )}
            </span>
  ...
  {errors.noticeType && (
    <p className="mt-1 text-xs text-red-500">{errors.noticeType.message}</p>
  )}
</div>

              <div className="md:col-span-2">
                <Label htmlFor="publishDate">Publish Date <span className="text-rose-500">*</span></Label>
                <Input
                ...
                />
                {errors.publishDate && (
                  <p className="mt-1 text-xs text-red-500">{errors.publishDate.message}</p>
                )}
              </div>
            </div>
            ...
            {/* Notice Body */}
            <div>
              <Label htmlFor="body">Notice Body <span className="text-rose-500">*</span></Label>
              <Textarea
                {...register("body")}
                  ...
                  <div className="flex items-center justify-center rounded-lg border-2 border-dashed border-muted-foreground/25 px-6 py-10 text-center">
                    <div className="space-y-1">
                      ...
                      <div className="text-sm text-muted-foreground">
                        <label htmlFor="file" className="cursor-pointer font-medium text-rose-600 hover:text-rose-500">
                        ...
                        <p className="text-xs">Accepted File Type: jpg, png, pdf</p>
                      </div>
                    </div>
                  </div>
                ) : (
        ...
        <DialogContent className="sm:max-w-md">
          <div className="flex flex-col items-center text-center">
            ...
            <DialogHeader className="mt-6">
              <DialogTitle className="text-2xl">Notice Published Successfully</DialogTitle>
            </DialogHeader>
            ...
            <div className="mt-8 flex w-full gap-3">
              <Button variant="outline" className="flex-1" onClick={() => setOpenSuccess(false)}>
                View Notice
              </Button>
              <Button variant="default" className="flex-1" onClick={() => setOpenSuccess(false)}>
                Create Another
              </Button>
